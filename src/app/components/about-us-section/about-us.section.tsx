...
flex flex-col w-full pb-4 pt-24 scroll-mt-20 pt-24 scroll-mt-20'
    ...
    wow animate__animated animate__fadeInDown pt-16 select-none"
      ...
      <div className='flex flex-col justify-center lg:flex-row px-8'>
        <div className='flex justify-center items-center animate__animated animate__fadeInLeft mx-24'>
          <Image
            width='200'
            height='200'
            src={
        ...
        <div className='select-none lg:flex-1 lg:max-w-[40%] flex flex-col justify-center wow animate__animated animate__fadeInRight text-gray-800 dark:text-slate-300'>
          ...
          <p className='mx-8 mb-4 text-2xl italic'>
